var ytAboutLayer = (function () {
	...
	ytAboutLayer.prototype.addAboutTxt = function () {
		...
		txtTemplate.size = 15;
		txtTemplate.color = "orange";

		var txtList = [
			"A: Espero que voce conheca quem e o desenvolvedor desse jogo ?",
			"Y: eu,eu sou RICHARD, explicador senior do Centro Academico de Ciencias Quimicas."
		];
